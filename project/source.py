...
def make_double_cycled_graph_and_save_into_dot(number_of_nodes_first_cycle: int,
                                               number_of_nodes_second_cycle: int,
                                               labels: tuple[str, str], file_name: str):
    graph = cfpq_data.graphs.generators.labeled_two_cycles_graph(number_of_nodes_first_cycle,
                                                                 number_of_nodes_second_cycle,
                                                                 labels=labels)
    """
