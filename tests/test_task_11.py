...
@pytest.mark.parametrize(
    ...
    [
        ...
        ('a = set_final({2, 3},set_start({},load_graph("my_simple_graph.txt")));', bool(1)),
        ('a = add_start({a, 2}, set_final({2, 3},set_start({},load_graph("my_simple_graph.txt"))));', bool(1)),
        ('a = add_final({b, c}, add_start({}, set_final({2, 3},set_start({},load_graph("my_simple_graph.txt")))));', bool(1)),
        ('a = add_final(add_start({}, set_final({2, 3},set_start({},load_graph("my_simple_graph.txt")))));', bool(0)),
